...
/***/ function(module, exports, __webpack_require__) {
	...
	React.render(React.createElement(QuestionsBox, null), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ReactFire = __webpack_require__(158);
	var Firebase = __webpack_require__(159);
	var FinalScore = __webpack_require__(160);
	var QuestionPrompt = __webpack_require__(161);
	var Timer = __webpack_require__(162);
	var Score = __webpack_require__(163);
	var Choices = __webpack_require__(164);
	var QuestionImage = __webpack_require__(165);
	var ScoreBoard = __webpack_require__(166);
	...
	module.exports = React.createClass({
		...
		choiceMade: function choiceMade(id) {
			...
			var quizActive;
			if (this.state.quiz[0][this.state.currentQuestion].answer == id) {
				//correct
		...
		render: function render() {
			...
			return React.createElement(
				...
				this.state.quizActive && this.state.loaded && React.createElement(
					'div',
					null,
		...
		render: function render() {
			...
			var choices = this.props.choices.map(function (choice, i) {
				return React.createElement(
					...
					React.createElement(
						'button',
						{ style: styles, className: 'button-xlarge pure-button',
